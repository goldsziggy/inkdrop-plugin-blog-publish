...
exports.publishToGhost = publishToGhost;
exports.syncWithGhost = syncWithGhost;
...
function getGhostAPIObj() {
  ...
  const url = inkdrop.config.get('ghost-publish.ghostUrl'); // leaving the content API in here in case there is a need in the future
